...
theme.confdir                       = os.getenv("HOME") .. "/.config/awesome/themes/vertex-awesome"

theme.font                          = "Terminus 8"
theme.taglist_font                  = "Terminus 8"
theme.bg_normal                     = "#2b2b2c"
theme.bg_focus                      = "#2b2b2c"
theme.bg_urgent                     = "#4b4b4c"
theme.bg_minimize                   = "#2b2b2c"
